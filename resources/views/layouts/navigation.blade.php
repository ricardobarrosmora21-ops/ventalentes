<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="space-x-4">
                        <a href="{{ route('register') }}" class="text-blue-600 hover:underline">Login</a>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @else
                <!-- aquí tu menú original para autenticados -->
            @endguest
        </div>
        ...
        @guest
            <div class="pt-4 pb-1 border-t border-gray-200 px-4 space-y-2">
                <a href="{{ route('register') }}" class="text-blue-600 hover:underline block">Login</a>
                <a href="{{ route('register') }}" class="text-green-600 hover:underline block">Register</a>
            </div>
        @endguest
    </div>
</nav>
